...
HandleDown:
  LDA #%0011000 ;Duty Cycle 00, Volume 8 (half volume)
  STA SQ2_ENV
  ...
  ;Colocando som no botãoBaixo

  lda #%00000000 ;enable Triangle channel
  sta $4015;;

   lda #%10000001 ;disable counters, non-zero Value turns channel on
   sta $4008
 
   lda #$38   ;a period of $042 plays a G# in NTSC mode.
   sta $400A
...
;Colocando som no botão esquerda
  ...
  sta $4015;;
   ...
   lda #$46   ;a period of $042 plays a G# in NTSC mode.
   sta $400A
...
;  Colocando som no botão direita
  ...
  sta $4015;;
   ...
   lda #$40   ;a period of $042 plays a G# in NTSC mode.
   sta $400A
